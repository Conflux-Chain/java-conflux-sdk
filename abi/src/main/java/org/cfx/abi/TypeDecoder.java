...
import org.cfx.abi.datatypes.Fixed;
import org.cfx.abi.datatypes.FixedPointType;
import org.cfx.abi.datatypes.Int;
import org.cfx.abi.datatypes.IntType;
import org.cfx.abi.datatypes.NumericType;
import org.cfx.abi.datatypes.StaticArray;
import org.cfx.abi.datatypes.Type;
import org.cfx.abi.datatypes.Ufixed;
    ...
    static Type instantiateArrayType(TypeReference ref, Object value)
        ...
        if (value instanceof List) {
            ...
            throw new ClassCastException(
                    "Arg of type "
                            + value.getClass()
                            + " should be a list to instantiate cfx Array");
        }
        ...
        if (arraySize <= 0) {
            ...
            Class<?> arrayClass =
                    Class.forName("org.cfx.abi.datatypes.generated.StaticArray" + arraySize);
        ...
        try {
            Class<? extends StaticArray> arrayClass =
                    (Class<? extends StaticArray>)
                            Class.forName("org.cfx.abi.datatypes.generated.StaticArray" + length);
