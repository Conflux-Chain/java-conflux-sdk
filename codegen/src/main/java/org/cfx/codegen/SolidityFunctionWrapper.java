...
import org.cfx.protocol.core.RemoteFunctionCall;
import org.cfx.protocol.core.methods.request.CfxFilter;
import org.cfx.protocol.core.methods.response.AbiDefinition;
import org.cfx.protocol.core.methods.response.BaseEventResponse;
...
import org.cfx.utils.Collection;
import org.cfx.utils.Strings;
import org.cfx.utils.Version;
...
public class SolidityFunctionWrapper extends Generator {
    ...
    private static final String CFX = "cfx";
    ...
    MethodSpec buildEventFlowableFunction(
        ...
        MethodSpec.Builder flowableMethodBuilder =
                MethodSpec.methodBuilder(generatedFunctionName)
                        .addModifiers(Modifier.PUBLIC)
                        .addParameter(CfxFilter.class, FILTER)
