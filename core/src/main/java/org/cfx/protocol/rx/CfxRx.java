...
public interface CfxRx {
     ...
     *     on the blockchain
     */
    Flowable<String> cfxBlockHashFlowable();
     ...
     */
    Flowable<String> cfxPendingTransactionHashFlowable();
     ...
     *     blockchain
     */
    Flowable<CfxBlock> blockFlowable(boolean fullTransactionObjects);
     ...
     */
    Flowable<CfxBlock> replayPastBlocksFlowable(
     ...
     *     in the {@link CfxBlock} responses
     ...
     */
    Flowable<CfxBlock> replayPastAndFutureBlocksFlowable(
            DefaultBlockParameter startBlock, boolean fullTransactionObjects);
