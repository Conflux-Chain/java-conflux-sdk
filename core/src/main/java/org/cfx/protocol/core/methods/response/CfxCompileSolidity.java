...
public class CfxCompileSolidity extends Response<Map<String, CfxCompileSolidity.Code>> {

    public Map<String, CfxCompileSolidity.Code> getCompiledSolidity() {
        return getResult();
    }

    public static class Code {
        private String code;
        private CfxCompileSolidity.SolidityInfo info;
        ...
        public Code(String code, CfxCompileSolidity.SolidityInfo info) {
            this.code = code;
            this.info = info;
        }
        ...
        public CfxCompileSolidity.SolidityInfo getInfo() {
            return info;
        }

        public void setInfo(CfxCompileSolidity.SolidityInfo info) {
            this.info = info;
        }
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof CfxCompileSolidity.Code)) {
                return false;
            }

            CfxCompileSolidity.Code code1 = (CfxCompileSolidity.Code) o;
    ...
    public static class SolidityInfo {
        ...
        private CfxCompileSolidity.Documentation userDoc;
        private CfxCompileSolidity.Documentation developerDoc;
        ...
        public SolidityInfo(
                ...
                CfxCompileSolidity.Documentation userDoc,
                CfxCompileSolidity.Documentation developerDoc) {
            this.source = source;
        ...
        public CfxCompileSolidity.Documentation getUserDoc() {
            return userDoc;
        }

        public void setUserDoc(CfxCompileSolidity.Documentation userDoc) {
            this.userDoc = userDoc;
        }

        public CfxCompileSolidity.Documentation getDeveloperDoc() {
            return developerDoc;
        }

        public void setDeveloperDoc(CfxCompileSolidity.Documentation developerDoc) {
            this.developerDoc = developerDoc;
        }
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof CfxCompileSolidity.SolidityInfo)) {
                return false;
            }

            CfxCompileSolidity.SolidityInfo that = (CfxCompileSolidity.SolidityInfo) o;
    ...
    public static class Documentation {
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof CfxCompileSolidity.Documentation)) {
                return false;
            }

            CfxCompileSolidity.Documentation that = (CfxCompileSolidity.Documentation) o;
