...
public class CfxBlock extends Response<CfxBlock.Block> {

    @Override
    @JsonDeserialize(using = CfxBlock.ResponseDeserialiser.class)
    public void setResult(CfxBlock.Block result) {
        super.setResult(result);
    }

    public CfxBlock.Block getBlock() {
        return getResult();
    }
    ...
    public static class Block {
        ...
        private List<CfxBlock.TransactionResult> transactions;
        ...
        public Block(
                ...
                String gasUsed,
                String timestamp,
                List<CfxBlock.TransactionResult> transactions,
                List<String> uncles,
        ...
        public List<CfxBlock.TransactionResult> getTransactions() {
            return transactions;
        }

        @JsonDeserialize(using = CfxBlock.ResultTransactionDeserialiser.class)
        public void setTransactions(List<CfxBlock.TransactionResult> transactions) {
            this.transactions = transactions;
        }
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof CfxBlock.Block)) {
                return false;
            }

            CfxBlock.Block block = (CfxBlock.Block) o;
    ...
    public static class TransactionHash implements CfxBlock.TransactionResult<String> {
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof CfxBlock.TransactionHash)) {
                return false;
            }

            CfxBlock.TransactionHash that = (CfxBlock.TransactionHash) o;
    ...
    public static class TransactionObject extends Transaction
            implements CfxBlock.TransactionResult<Transaction> {
    ...
    public static class ResultTransactionDeserialiser
            extends JsonDeserializer<List<CfxBlock.TransactionResult>> {

        private ObjectReader objectReader = ObjectMapperFactory.getObjectReader();

        @Override
        public List<CfxBlock.TransactionResult> deserialize(
                JsonParser jsonParser, DeserializationContext deserializationContext)
                throws IOException {

            List<CfxBlock.TransactionResult> transactionResults = new ArrayList<>();
            JsonToken nextToken = jsonParser.nextToken();

            if (nextToken == JsonToken.START_OBJECT) {
                Iterator<CfxBlock.TransactionObject> transactionObjectIterator =
                        objectReader.readValues(jsonParser, CfxBlock.TransactionObject.class);
                ...
                Iterator<CfxBlock.TransactionHash> transactionHashIterator =
                        objectReader.readValues(jsonParser, CfxBlock.TransactionHash.class);
    ...
    public static class ResponseDeserialiser extends JsonDeserializer<CfxBlock.Block> {

        private ObjectReader objectReader = ObjectMapperFactory.getObjectReader();

        @Override
        public CfxBlock.Block deserialize(
                JsonParser jsonParser, DeserializationContext deserializationContext)
                throws IOException {
            if (jsonParser.getCurrentToken() != JsonToken.VALUE_NULL) {
                return objectReader.readValue(jsonParser, CfxBlock.Block.class);
            } else {
