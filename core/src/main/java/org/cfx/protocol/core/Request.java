...
public class Request<S, T extends Response> {
    ...
    public Request(String method, List<S> params, CfxService cfxService, Class<T> type) {
        this.method = method;
        this.params = params;
    ...
    public T send() throws IOException {
        return cfxService.send(this, responseType);
    }

    public CompletableFuture<T> sendAsync() {
        return cfxService.sendAsync(this, responseType);
    }
