...
import org.cfx.abi.EventValues;
...
import org.cfx.tx.exceptions.ContractCallException;
...
public abstract class Contract extends ManagedTransaction {
    ...
    protected Contract(
        ...
        super(ensResolver, cfx, transactionManager);
    ...
    protected Contract(
        ...
        this(
                ...
                contractAddress,
                cfx,
                new RawTransactionManager(cfx, credentials),
                gasProvider);
    }
    ...
    protected Contract(
            ...
            BigInteger gasPrice,
            BigInteger gasLimit) {
        this("", contractAddress, cfx, transactionManager, gasPrice, gasLimit);
    }
    ...
    protected static <T extends Contract> T deploy(
        ...
        try {
            ...
            T contract = constructor.newInstance(null, cfx, credentials, contractGasProvider);
    ...
    protected static <T extends Contract> T deploy(
        ...
        try {
            ...
            // we want to use null here to ensure that "to" parameter on message is not populated
            T contract =
                    constructor.newInstance(null, cfx, transactionManager, contractGasProvider);
            return create(contract, binary, encodedConstructor, value);
        } catch (TransactionException e) {
            throw e;
        } catch (Exception e) {
