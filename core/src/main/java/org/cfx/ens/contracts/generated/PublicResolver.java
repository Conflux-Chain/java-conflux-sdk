package org.cfx.ens.contracts.generated;
...
import org.cfx.abi.EventEncoder;
...
public class PublicResolver extends Contract {
    ...
    @Deprecated
    protected PublicResolver(String contractAddress, Cfx cfx, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, cfx, credentials, gasPrice, gasLimit);
    }

    protected PublicResolver(String contractAddress, Cfx cfx, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, cfx, credentials, contractGasProvider);
    }

    @Deprecated
    protected PublicResolver(String contractAddress, Cfx cfx, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, cfx, transactionManager, gasPrice, gasLimit);
    }

    protected PublicResolver(String contractAddress, Cfx cfx, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public static RemoteCall<PublicResolver> deploy(Cfx cfx, Credentials credentials, ContractGasProvider contractGasProvider, String ensAddr) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new Address(ensAddr)));
        return deployRemoteCall(PublicResolver.class, cfx, credentials, contractGasProvider, BINARY, encodedConstructor);
    }

    public static RemoteCall<PublicResolver> deploy(Cfx cfx, TransactionManager transactionManager, ContractGasProvider contractGasProvider, String ensAddr) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new Address(ensAddr)));
        return deployRemoteCall(PublicResolver.class, cfx, transactionManager, contractGasProvider, BINARY, encodedConstructor);
    }

    @Deprecated
    public static RemoteCall<PublicResolver> deploy(Cfx cfx, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, String ensAddr) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new Address(ensAddr)));
        return deployRemoteCall(PublicResolver.class, cfx, credentials, gasPrice, gasLimit, BINARY, encodedConstructor);
    }

    @Deprecated
    public static RemoteCall<PublicResolver> deploy(Cfx cfx, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, String ensAddr) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new Address(ensAddr)));
        return deployRemoteCall(PublicResolver.class, cfx, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor);
    }
    ...
    public Flowable<AddrChangedEventResponse> addrChangedEventFlowable(CfxFilter filter) {
        return cfx.cfxLogFlowable(filter).map(new io.reactivex.functions.Function<Log, AddrChangedEventResponse>() {
            @Override
    ...
    public Flowable<AddrChangedEventResponse> addrChangedEventFlowable(DefaultBlockParameter startBlock, DefaultBlockParameter endBlock) {
        CfxFilter filter = new CfxFilter(startBlock, endBlock, getContractAddress());
    ...
    public Flowable<ContentChangedEventResponse> contentChangedEventFlowable(CfxFilter filter) {
        return cfx.cfxLogFlowable(filter).map(new io.reactivex.functions.Function<Log, ContentChangedEventResponse>() {
            @Override
    ...
    public Flowable<NameChangedEventResponse> nameChangedEventFlowable(CfxFilter filter) {
        return cfx.cfxLogFlowable(filter).map(new io.reactivex.functions.Function<Log, NameChangedEventResponse>() {
            @Override
    ...
    public Flowable<ABIChangedEventResponse> aBIChangedEventFlowable(CfxFilter filter) {
        return cfx.cfxLogFlowable(filter).map(new io.reactivex.functions.Function<Log, ABIChangedEventResponse>() {
            @Override
    ...
    public Flowable<PubkeyChangedEventResponse> pubkeyChangedEventFlowable(CfxFilter filter) {
        return cfx.cfxLogFlowable(filter).map(new io.reactivex.functions.Function<Log, PubkeyChangedEventResponse>() {
            @Override
    ...
    public Flowable<TextChangedEventResponse> textChangedEventFlowable(CfxFilter filter) {
        return cfx.cfxLogFlowable(filter).map(new io.reactivex.functions.Function<Log, TextChangedEventResponse>() {
            @Override
    ...
    @Deprecated
    public static PublicResolver load(String contractAddress, Cfx cfx, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new PublicResolver(contractAddress, cfx, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static PublicResolver load(String contractAddress, Cfx cfx, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new PublicResolver(contractAddress, cfx, transactionManager, gasPrice, gasLimit);
    }

    public static PublicResolver load(String contractAddress, Cfx cfx, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new PublicResolver(contractAddress, cfx, credentials, contractGasProvider);
    }

    public static PublicResolver load(String contractAddress, Cfx cfx, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new PublicResolver(contractAddress, cfx, transactionManager, contractGasProvider);
    }
