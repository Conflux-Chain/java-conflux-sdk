...
public class ENS extends Contract {
    ...
    @Deprecated
    protected ENS(String contractAddress, Cfx cfx, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, cfx, credentials, gasPrice, gasLimit);
    }

    protected ENS(String contractAddress, Cfx cfx, Credentials credentials, ContractGasProvider contractGasProvider) {
        super(BINARY, contractAddress, cfx, credentials, contractGasProvider);
    }

    @Deprecated
    protected ENS(String contractAddress, Cfx cfx, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        super(BINARY, contractAddress, cfx, transactionManager, gasPrice, gasLimit);
    }

    protected ENS(String contractAddress, Cfx cfx, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
    ...
    public static RemoteCall<ENS> deploy(Cfx cfx, Credentials credentials, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(ENS.class, cfx, credentials, contractGasProvider, BINARY, "");
    }

    public static RemoteCall<ENS> deploy(Cfx cfx, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return deployRemoteCall(ENS.class, cfx, transactionManager, contractGasProvider, BINARY, "");
    }

    @Deprecated
    public static RemoteCall<ENS> deploy(Cfx cfx, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(ENS.class, cfx, credentials, gasPrice, gasLimit, BINARY, "");
    }

    @Deprecated
    public static RemoteCall<ENS> deploy(Cfx cfx, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return deployRemoteCall(ENS.class, cfx, transactionManager, gasPrice, gasLimit, BINARY, "");
    }
    ...
    public Flowable<NewOwnerEventResponse> newOwnerEventFlowable(CfxFilter filter) {
        return cfx.cfxLogFlowable(filter).map(new io.reactivex.functions.Function<Log, NewOwnerEventResponse>() {
            @Override
    ...
    public Flowable<TransferEventResponse> transferEventFlowable(CfxFilter filter) {
        return cfx.cfxLogFlowable(filter).map(new io.reactivex.functions.Function<Log, TransferEventResponse>() {
            @Override
    ...
    public Flowable<NewResolverEventResponse> newResolverEventFlowable(CfxFilter filter) {
        return cfx.cfxLogFlowable(filter).map(new io.reactivex.functions.Function<Log, NewResolverEventResponse>() {
            @Override
    ...
    public Flowable<NewTTLEventResponse> newTTLEventFlowable(CfxFilter filter) {
        return cfx.cfxLogFlowable(filter).map(new io.reactivex.functions.Function<Log, NewTTLEventResponse>() {
            @Override
    ...
    @Deprecated
    public static ENS load(String contractAddress, Cfx cfx, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new ENS(contractAddress, cfx, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static ENS load(String contractAddress, Cfx cfx, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new ENS(contractAddress, cfx, transactionManager, gasPrice, gasLimit);
    }

    public static ENS load(String contractAddress, Cfx cfx, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new ENS(contractAddress, cfx, credentials, contractGasProvider);
    }

    public static ENS load(String contractAddress, Cfx cfx, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new ENS(contractAddress, cfx, transactionManager, contractGasProvider);
    }
